...
#        input('\nPresiona una tecla para continuar...')
    ...
    def insert_factura(self):
        fecha = input_data('Ingrese la fecha de emisión de la factura >> ')
        producto = input_data('Ingrese el producto >> ')
        cantidad_vendida = input_data('Ingrese la cantidad vendida >> ')
        precio_unitario = input_data('Ingrese el precio unitario >> ')
        monto_factura = input_data('Ingrese el monto_factura >> ')
