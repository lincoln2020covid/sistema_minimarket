...
class AdministradorController:
    ...
    def all_facturas(self):
        try:
            ...
            ==========================
            ''')
            factura = self.factura.get_facturas('id_factura')
            print(print_table(factura, ['fecha', 'producto', 'cantidad_vendida', 'precio_unitario', 'monto_factura', 'id_factura', 'id_producto']))
